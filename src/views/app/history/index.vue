    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-sm text-muted-foreground mt-1">查看您的所有内容生成历史记录</p>
        </div>
      ...
      >
        <div class="text-center space-y-3">
          ...
          <p class="text-sm text-muted-foreground">开始创建您的第一个内容生成任务吧</p>
          ...
          <CardContent class="p-0">
            ...
            <div class="p-4 space-y-3">
              ...
              <div class="flex gap-2 pt-2">
                <Button variant="outline" size="sm" class="flex-1" @click.stop="viewDetail(item)">
                  查看详情
                </Button>
                <Button variant="outline" size="sm" @click.stop="deleteGeneration(item.id)">
